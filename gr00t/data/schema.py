...
class DatasetStatistics(BaseModel):
    ...
    progress: dict[str, DatasetStatisticalValues] = Field(..., description="Statistics of task progress")
...
class DatasetModalities(BaseModel):
    ...
    progress: dict[str, StateActionMetadata] = Field(default_factory=dict, description="Metadata of task progress")
